...
%         %Ajout
%         %NIG=[0.1442 0.0119 7.7975 -0.5260]; %CAS 1
%         %NIG=[0.1290 0.0101 1.2792 0.1527]; %CAS 2 CAS BON
%         %NIG=[0.3870 0.0303 0.4263 -0.0335];
%         %CAS CODE RAFAL
%         NIG=[0.1277 0.0096 1.2718 0.0897];
%         
%         iyy=nigpdf(xi,NIG(1),NIG(2),NIG(3),NIG(4));
%         plot(xi,iyy,'k','LineWidth',1.5);
%         %VG
%         VG=[0.6226 0.3971 -0.0007 0.2960];
%         iyy2=Pdf_VG(VG,xi);
%         plot(xi,iyy2,'y','LineWidth',1.5);
%         %NIG Autre fonction plot
%         iyy3=Pdf_GH([-0.5 0.1290 0.0101 0.1527 1.2792],xi)
%         plot(xi,iyy3,'g','LineWidth',1.5);
