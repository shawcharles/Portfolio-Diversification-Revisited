...
%This transformation does not change the exp, the variance, or the Skewness, but just the higher moments.

gama0=sqrt(alpha0^2-betha0^2);
% Calculation of the first three moments X de loi NIG(alpha0,betha0,delta0,mu0)
